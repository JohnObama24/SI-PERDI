...
@section('content')
    ...
    <div class="mb-8">
        <button
            class="bg-black text-white px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-gray-800 transition-colors" onclick="window.location='{{ route('pegawai-form') }}'">
        ...
        <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-2">
                            <h4 class="font-semibold text-gray-900">Bandung</h4>
                            <span class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">Ditolak</span>
                        </div>
                        <p class="text-sm text-gray-600 mb-2">Meeting dengan Klien</p>
                        <div class="flex items-center space-x-4 text-sm text-gray-500">
                            <span>17/08/2024 - 20/08/2024</span>
                            <span>Diajukan 10/08/2024</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-2">
                            <h4 class="font-semibold text-gray-900">Surabaya</h4>
                            <span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Disetujui</span>
                        </div>
                        <p class="text-sm text-gray-600 mb-2">Seminar Google I/O</p>
                        <div class="flex items-center space-x-4 text-sm text-gray-500">
                            <span>21/12/2023 - 23/12/2023</span>
                            <span>Diajukan 22/12/2023</span>
                        </div>
                    </div>
                </div>
            </div>
